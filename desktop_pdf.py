...
class DocumentProcessorApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("RSC systems pvt Ltd (Resume Parser 1.0)")
        ...
        self.setGeometry(int(screen_center_x), int(screen_center_y), window_width, window_height)
        ...
        pixmap = QPixmap("logoRSCsys (2).png")  # Adjust the path to your logo image
        self.logo_label.setPixmap(pixmap)

        # Add logo label to layout and center it
    ...
    def apply_button_styles(self):
        ...
        self.retrieve_button.setStyleSheet(button_style)
